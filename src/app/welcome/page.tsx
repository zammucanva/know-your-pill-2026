...
const roles: { id: Role; label: string; description: string; icon: typeof User }[] = [
  {
    id: "patient",
    label: "Patient",
    description: "Understand medications, conditions, side effects, and treatment information in plain language.",
    icon: HeartPulse,
  },
  {
    id: "mbbs_student",
    label: "MBBS Student",
    description: "Learn pharmacology, pathology, physiology, anatomy, and clinical medicine.",
    icon: GraduationCap,
  },
  {
    id: "exam_aspirant",
    label: "NEET PG / INICET / FMGE Aspirant",
    description: "Focus on high-yield concepts, PYQs, clinical reasoning, and exam preparation.",
    icon: Award,
  },
  {
    id: "psychiatry_resident",
    label: "Psychiatry Resident",
    description: "Explore psychopharmacology, neuropsychiatry, clinical cases, and advanced clinical reasoning.",
    icon: Stethoscope,
  },
  {
    id: "healthcare_professional",
    label: "Healthcare Professional",
    description: "Use KYP for clinical learning, pharmacology review, patient education, and continuing medical knowledge.",
    icon: User,
  },
];
        ...
        {step === "welcome" && (
          <div className="text-center">
            ...
            <p className="mt-6 text-xs text-muted-foreground">
              By continuing, you agree to KYP's educational use terms.
            </p>
          </div>
        )}
        ...
        {step === "signup" && (
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">Start learning medicine visually.</p>
            </div>
            ...
            {error && (
              <p className="rounded-lg border border-emergency/30 bg-emergency-soft/20 px-3 py-2 text-xs text-emergency">
                {error}
              </p>
            )}
            ...
            <p className="text-center text-xs text-muted-foreground">
              ...
              <button type="button" onClick={() => { setStep("login"); setError(""); }} className="font-medium text-brand hover:underline">
                Log in
              </button>
            </p>
          </form>
        ...
        {step === "login" && (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <p className="text-center text-xs text-muted-foreground">
              ...
              <button type="button" onClick={() => { setStep("signup"); setError(""); }} className="font-medium text-brand hover:underline">
                Create one
              </button>
            </p>
          </form>
        ...
        {step === "verify" && (
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Email verification helps secure your account and enables progress tracking across devices.
              You can verify later — KYP is ready for you now.
            </p>

            <div className="mt-8 space-y-3">
              <Button onClick={() => setStep("role")} className="w-full rounded-xl" size="lg">
                Verify email
              </Button>
              <Button
        ...
        {step === "role" && (
          <div>
            <h2 className="font-serif text-2xl font-semibold tracking-tight text-center">
              How will you primarily use KYP?
            </h2>
            <p className="mt-2 text-center text-sm text-muted-foreground">
              This helps us prioritize the right content. You can change this anytime.
            </p>
            ...
            {error && (
              <p className="mt-3 rounded-lg border border-emergency/30 bg-emergency-soft/20 px-3 py-2 text-xs text-emergency">
                {error}
              </p>
            )}
